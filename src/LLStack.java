...
public class LLStack {
	...
	private class Node  {
		 ...
		 * Sets data and reference to next item to null.
		 */
		public Node(){
			data = null;
			next = null;
	...
	/**
	 * @param itemData - Some Object
	 * Adds a node as the first node element at the start of the list
	 * with the specified data.
	 * Simply makes call to Node class constructor and passes in new item.
	 */
	...
	/**
	 * @param item
	 * @return - Returns boolean value on the condition 
	 * there is match for the given object.
	 */
	...
	/**
	 * @param target
	 * @return - Finds the first node containing the target item, and returns a
	...
	/**
	 * Outputs the links of Nodes in no particular sorted order.
	 */
	...
	/**
	 * @return - Returns boolean value on the condition the entire
